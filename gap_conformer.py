...
class ExP():
    def __init__(self, train_subs, val_sub, test_sub, mdl=False, mdl_ratio=0.5):
        ...
        self.results_root = './results_gap/'
        if(not os.path.exists(self.results_root)):
            os.makedirs(self.results_root)
        
        if(mdl):
            self.log_write_file = os.path.join(self.results_root, "log_subject%d_mdl.txt" % self.test_sub)
        else:
            self.log_write_file = os.path.join(self.results_root, "log_subject%d.txt" % self.test_sub)
        ...
        self.model_save_path = '/home/msai/anishmad001/codes/EEG-Conformer/models_gap/'
...
def main():
    ...
    if(not mdl):
        result_write_file = "./results_gap/sub_result.txt"
    else:
        result_write_file = "./results_gap/sub_result_mdl.txt"
