...
class ExP():
    def __init__(self, train_subs, val_sub, test_sub, deepconv_args, mdl=False, mdl_ratio=0.5):
        super(ExP, self).__init__()
        self.batch_size = 72
        self.n_epochs = 1500
        self.n_finetune_epochs = 200
        self.c_dim = 4
        self.lr = 0.0002
        self.b1 = 0.5
        self.b2 = 0.999
        ...
        if(mdl):
            self.log_write_file = "./results_deep/log_subject%d_mdl.txt" % self.test_sub
        else:
            self.log_write_file = "./results_deep/log_subject%d.txt" % self.test_sub
        ...
        self.model_save_path = '/home/msai/anishmad001/codes/EEG-Conformer/models_deep/'
...
def main():
    ...
    if(not mdl):
        result_write_file = "./results_deep/sub_result.txt"
    else:
        result_write_file = "./results_deep/sub_result_mdl.txt"
    ...
    for i, sub in enumerate(subs):
        ...
        exp = ExP(train_subs, val_sub, test_sub, deepconv_args, mdl=mdl)
        if(i == 0):
