...
data_path = '/home/msai/anishmad001/codes/FBCNet/data/bci42a/originalData/'
result_path = '/home/msai/anishmad001/codes/EEG-Conformer/data/'
session_types = ['T', 'E']
...
for name in SUBJECTS_BCI_IV:
    for session_type in session_types:
        ...
        print("BCI events:", events)
        exit(0)
        epochs = mne.Epochs(data, events[0], event_id=events[1]['768'], tmin=0, tmax=4, baseline=None, detrend=None, preload=True)
        ...
        epoched_data = epoched_data[:, :22, :1000]
        epoched_data = np.transpose(epoched_data, (2, 1, 0))
